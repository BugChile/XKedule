...
export default class InfoCard extends React.Component {
  ...
  generateLinkComponent(linkComponent) {
    if (linkComponent) {
      return <InfoCardLinks links={this.props.event.links} />;
    }
    return <div></div>;
  }
  render() {
      ...
      switch (this.props.event) {
        ...
        default:
          return (
            <div
              value="1"
              className={[this.props.classesInfoCard, this.props.topValue].join(
                " "
              )}
            ...
            >
              ...
              <div className="button-container">
                {(() => {
                  switch (isEmpty(this.props.event.links)) {
                    ...
                    default:
                      return (
                        <ButtonFunction
                          function={this.props.functionLink}
                          cssClass="link"
                          cssIcon="glyphicon glyphicon-link"
                        />
                      );
                  }
                })()}
                <ButtonFunction
                  function={() => {
                    this.props.functionEdit(this.props.event);
