...
export default class LinkTool extends React.Component {
  ...
  saveLink() {
    ...
    if (
      this.state.new_link_href.indexOf("https://") !== 0 ||
      this.state.new_link_href.indexOf("http://") !== 0
    ) {
      href = "https://" + this.state.new_link_href;
    } else {
      href = this.state.new_link_href;
    }
    const link_object = { name: this.state.new_link_name, href };
    ...
    return (
      <div className={this.props.className}>
        <div className="horizontal_flex label_input_combo">
          <div className="input_label">Link name</div>
          <TextLineInput
        ...
        <div className="horizontal_flex label_input_combo">
          <div className="input_label">Link url</div>
          <TextLineInput
        ...
        <div className="horizontal_flex shrink_row">
          ...
          <span className="clickable_anchor" onClick={this.props.doneEditing}>
            Cancel
          </span>
        </div>
      </div>
