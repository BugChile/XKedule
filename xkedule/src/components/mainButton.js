...
export default class MainButton extends React.PureComponent {
  ...
  getIcon(icon_mode){
      switch (icon_mode) {
          ...
          case "save":
              return(
                  <svg id="expand_arrow" className="expand_arrow" width="53" height="41" viewBox="0 0 53 41" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  render() {
      return(
          <div id="main_button_container" className="main_button_container" onClick={this.props.function}>
              <div id="main_button" className="main_button linear_grad">
