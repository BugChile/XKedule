...
let loadEvents = hcEvents;
let loadTags = hcUserTags;
let userUid = 'uid';
let saveCallback = (a,b,c) => {console.log("save placeholder"); index +=1;return `${index}`;};
let updateCallback = (a,b,c,d) => {console.log("update placeholder");return d};
let deleteCallback = () => {console.log("delete placeholder");return "0"};
